...
class _ExploreScreenState extends State<ExploreScreen> {
  ...
  callGetFilteredDataList(
    ...
    RestClient(RetroApi().dioData()).filter(body).then((response) {
      print(response.success);
      progressDialog.hide();
      if (response.success) {
        setState(() {
  ...
  String getExploreRestaurantsFood(int index) {
    ...
    if(exploreRestaurantsFood.length < 4){
      print(exploreRestaurantsFood.length);
    return exploreRestaurantsFood.join(" , ");
    }else{
      print(exploreRestaurantsFood.length);
    return exploreRestaurantsFood.join(" , ").substring(1, 30) + '...';
                    ...
                    children: <Widget>[
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: <Widget>[
                            Container(
                              child: Padding(padding: EdgeInsets.all(16),child: Container(
                                                            ...
                                                            children: <Widget>[
                                                              ...
                                                              Row(
                                                                children: <
                                                                    Widget>[
                                                                  // Text(
                                                                  //   '${_exploreResListData[index].vendorType}', // type
                                                                  //   style: TextStyle(
                                                                  //       fontWeight:
                                                                  //           FontWeight
                                                                  //               .bold,
                                                                  ...
                                                                  // Text(
                                                                  //   '\$ ${_exploreResListData[index].review} ', //price
                                                                  //   style:
                                                                  //       TextStyle(
                                                                  //     fontFamily:
                                                                  //         'Poppins',
