...
class _EditProfileInformationState extends State<EditProfileInformation>
  ...
  String strImgbash64Profile, strCountryCode = '+968', _userPhoto = '';
  ...
  void callGetUserDetails() {
    RestClient(RetroApi().dioData()).user().then((response) {
      progressDialog.hide();
      print(response);
      setState(() {
  ...
  void callUpdateImage() {
    if (_image != null) {
      ...
      RestClient(RetroApi().dioData()).updateImage(body).then((response) {
        progressDialog.hide();
  ...
  void callUpdateUsername(String strLanguage) {
    ...
    RestClient(RetroApi().dioData()).updateUser(body).then((response) {
      progressDialog.hide();
      print(response.success);
      if (response.success) {
        Constants.toastMessage(response.data);
  ...
  void submitBankDetails() {
    ...
    RestClient(RetroApi().dioData()).bankDetails(body).then((response) {
      progressDialog.hide();
      print(response.success);
      if (response.success) {
        Constants.toastMessage(response.data);
