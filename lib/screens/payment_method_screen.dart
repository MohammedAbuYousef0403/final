...
class _PaymentMethodScreenState extends State<PaymentMethodScreen> {
  ...
  void callGetPaymentSettingAPI() {
    ...
    RestClient(dio).paymentSetting().then((response) {
  ...
  void placeOrder() {
    ...
    RestClient(RetroApi().dioData()).bookOrder(body).then((response) {
      progressDialog.hide();
      print(response);
      print(response.success);
      if (response.success) {
  ...
  void getWalletBalance() {
    ...
    RestClient(RetroApi().dioData()).getWalletBalance().then((response) {
      setState(() {
        progressDialog.hide();
      });
