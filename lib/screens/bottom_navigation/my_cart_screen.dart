...
/*          if (allRows[i]['pro_customization'] == '') {
        ...
        if (_products.length != null || _products.length != 0) {
          for (int i = 0; i < _products.length; i++) {
            if (_listRestaurantsMenu.length != null || _listRestaurantsMenu.length != 0) {
  ...
  void getTax() {
    ...
    RestClient(RetroApi().dioData()).getTax().then((response) {
      print(response.success);
      setState(() {
        _isSyncing = false;
      });
  ...
  void _update(int proId, int proQty, String proPrice, String proImage, String proName, int restId,
                      ...
                      children: [
                        Padding(
                          padding: EdgeInsets.only(
                              left: ScreenUtil().setWidth(10), right: ScreenUtil().setHeight(10)),
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: _userAddressList.length == 0 || _userAddressList.length == null
                                ? Container(
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.stretch,
                                      mainAxisAlignment: MainAxisAlignment.center,
...
*/ /*    setState(() {
  ...
  void callGetUserAddresses() {
    ...
    RestClient(RetroApi().dioData()).userAddress().then((response) {
      print(response.success);
      if (progressDialog.isShowing()) {
        progressDialog.hide();
      }
  ...
  void calculateDeliveryCharge(double subtotal) {
    RestClient(RetroApi().dioData()).orderSetting().then((response) {
      print(response.success);
      if (response.success) {
  ...
  void callApplyPromoCall(
      BuildContext context, String promocodeName, String orderDate, double orderAmount, int id) {
    progressDialog.show();
    ...
    RestClient(RetroApi().dioData()).applyPromoCode(body).then((response) {
      progressDialog.hide();
      print(response);
      ...
      switch (obj.runtimeType) {
        case DioError:
          ...
          if (responsecode == 401) {
            Constants.toastMessage('{status code : $responsecode - ${res.data}');
            print(responsecode);
            print(res.statusMessage);
          } else if (responsecode == 422) {
            print("code:$responsecode");
